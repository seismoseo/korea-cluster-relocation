"""Cluster config for f753_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f753_b515_reuse",
    region="f753_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f753_b515_reuse_cluster"),
    epicenter=(35.7421, 129.4586),
    region_bounds=(35.69, 35.794, 129.407, 129.511),
