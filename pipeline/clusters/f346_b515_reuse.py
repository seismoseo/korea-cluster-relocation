"""Cluster config for f346_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f346_b515_reuse",
    region="f346_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f346_b515_reuse_cluster"),
    epicenter=(35.7865, 129.3787),
