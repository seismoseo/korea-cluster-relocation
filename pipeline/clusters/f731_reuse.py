"""Cluster config for f731_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f731_reuse",
    region="f731_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f731_reuse_cluster"),
    epicenter=(35.6951, 129.3748),
    region_bounds=(35.643, 35.748, 129.322, 129.427),
