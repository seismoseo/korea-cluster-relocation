"""Cluster config for f1260_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1260_b515_reuse",
    region="f1260_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1260_b515_reuse_cluster"),
    epicenter=(35.7245, 129.4082),
    region_bounds=(35.667, 35.783, 129.349, 129.465),
