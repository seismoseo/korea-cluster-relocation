"""Cluster config for f899_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f899_b515_reuse",
    region="f899_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f899_b515_reuse_cluster"),
    epicenter=(35.7998, 129.4613),
    region_bounds=(35.747, 35.852, 129.406, 129.519),
