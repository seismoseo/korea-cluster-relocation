"""Cluster config for Hongcheon — auto-generated by PocketQuake."""
...
CONFIG = mixed_cluster(
    name="hongcheon",
    region="Hongcheon",
    src_root=os.path.join(config.PROJECT_ROOT, "Hongcheon_cluster"),
    epicenter=(37.923, 128.011),
    region_bounds=(37.7, 38.14, 127.8, 128.22),
