"""Cluster config for f222_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f222_b515_reuse",
    region="f222_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f222_b515_reuse_cluster"),
    epicenter=(35.8229, 129.4031),
    region_bounds=(35.772, 35.874, 129.35, 129.456),
