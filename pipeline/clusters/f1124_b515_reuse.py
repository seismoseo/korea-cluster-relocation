"""Cluster config for f1124_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1124_b515_reuse",
    region="f1124_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1124_b515_reuse_cluster"),
    epicenter=(35.7567, 129.3786),
    region_bounds=(35.705, 35.808, 129.326, 129.434),
