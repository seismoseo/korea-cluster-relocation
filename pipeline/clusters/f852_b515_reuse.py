"""Cluster config for f852_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f852_b515_reuse",
    region="f852_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f852_b515_reuse_cluster"),
    epicenter=(35.825, 129.4092),
    region_bounds=(35.774, 35.875, 129.356, 129.462),
