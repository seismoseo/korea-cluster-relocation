"""Cluster config for f116_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f116_b515_reuse",
    region="f116_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f116_b515_reuse_cluster"),
    epicenter=(35.6872, 129.3654),
    region_bounds=(35.632, 35.748, 129.306, 129.42),
