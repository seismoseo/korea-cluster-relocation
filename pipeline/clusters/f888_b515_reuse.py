"""Cluster config for f888_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f888_b515_reuse",
    region="f888_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f888_b515_reuse_cluster"),
    epicenter=(35.7426, 129.4153),
    region_bounds=(35.689, 35.799, 129.359, 129.476),
