"""Cluster config for f110_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f110_b515_reuse",
    region="f110_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f110_b515_reuse_cluster"),
    epicenter=(35.8078, 129.3305),
    region_bounds=(35.757, 35.859, 129.28, 129.382),
