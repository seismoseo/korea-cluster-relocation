"""Cluster config for f909_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f909_b515_reuse",
    region="f909_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f909_b515_reuse_cluster"),
    epicenter=(35.7677, 129.3797),
    region_bounds=(35.714, 35.819, 129.325, 129.434),
