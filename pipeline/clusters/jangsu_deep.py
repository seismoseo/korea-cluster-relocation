"""Cluster config for Jangsu_deep — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="jangsu_deep",
    region="Jangsu_deep",
    src_root=os.path.join(config.PROJECT_ROOT, "Jangsu_deep_cluster"),
    epicenter=(35.583, 127.593),
    region_bounds=(35.38, 35.79, 127.39, 127.8),
