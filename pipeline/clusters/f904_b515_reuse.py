"""Cluster config for f904_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f904_b515_reuse",
    region="f904_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f904_b515_reuse_cluster"),
    epicenter=(35.7018, 129.3587),
    region_bounds=(35.648, 35.756, 129.307, 129.41),
