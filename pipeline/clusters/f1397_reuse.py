"""Cluster config for f1397_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1397_reuse",
    region="f1397_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1397_reuse_cluster"),
    epicenter=(35.7764, 129.3911),
    region_bounds=(35.725, 35.828, 129.339, 129.443),
