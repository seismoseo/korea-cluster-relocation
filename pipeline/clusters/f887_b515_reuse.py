"""Cluster config for f887_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f887_b515_reuse",
    region="f887_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f887_b515_reuse_cluster"),
    epicenter=(35.7512, 129.4127),
    region_bounds=(35.697, 35.804, 129.357, 129.467),
