"""Cluster config for f1220_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1220_reuse",
    region="f1220_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1220_reuse_cluster"),
    epicenter=(35.7087, 129.3565),
    region_bounds=(35.656, 35.764, 129.305, 129.407),
