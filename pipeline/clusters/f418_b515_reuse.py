"""Cluster config for f418_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f418_b515_reuse",
    region="f418_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f418_b515_reuse_cluster"),
    epicenter=(35.6845, 129.5349),
    region_bounds=(35.634, 35.735, 129.484, 129.587),
