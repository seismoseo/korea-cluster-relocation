"""Cluster config for f1128_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1128_reuse",
    region="f1128_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1128_reuse_cluster"),
    epicenter=(35.823, 129.4042),
    region_bounds=(35.772, 35.874, 129.352, 129.456),
