"""Cluster config for f426_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f426_reuse",
    region="f426_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f426_reuse_cluster"),
    epicenter=(35.7756, 129.3151),
    region_bounds=(35.72, 35.828, 129.263, 129.367),
