"""Cluster config for f710_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f710_b515_reuse",
    region="f710_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f710_b515_reuse_cluster"),
    epicenter=(35.7283, 129.4032),
    region_bounds=(35.672, 35.786, 129.347, 129.461),
