"""Cluster config for f1377_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1377_reuse",
    region="f1377_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1377_reuse_cluster"),
    epicenter=(35.7214, 129.4042),
    region_bounds=(35.671, 35.772, 129.352, 129.457),
