"""Cluster config for f410_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f410_b515_reuse",
    region="f410_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f410_b515_reuse_cluster"),
    epicenter=(35.7989, 129.4375),
    region_bounds=(35.745, 35.853, 129.386, 129.49),
