"""Cluster config for Namwon — auto-generated by PocketQuake."""
...
CONFIG = mixed_cluster(
    name="namwon",
    region="Namwon",
    src_root=os.path.join(config.PROJECT_ROOT, "Namwon_cluster"),
    epicenter=(35.364, 127.3),
    region_bounds=(35.16, 35.57, 127.09, 127.51),
