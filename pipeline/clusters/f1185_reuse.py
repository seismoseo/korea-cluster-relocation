"""Cluster config for f1185_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1185_reuse",
    region="f1185_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1185_reuse_cluster"),
    epicenter=(35.7531, 129.3853),
    region_bounds=(35.691, 35.826, 129.331, 129.445),
