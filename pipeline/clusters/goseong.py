"""Cluster config for Goseong — auto-generated by PocketQuake."""
...
CONFIG = mixed_cluster(
    name="goseong",
    region="Goseong",
    src_root=os.path.join(config.PROJECT_ROOT, "Goseong_cluster"),
    epicenter=(35.077, 128.489),
    region_bounds=(34.87, 35.3, 128.25, 128.73),
