"""Cluster config for f176_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f176_b515_reuse",
    region="f176_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f176_b515_reuse_cluster"),
    epicenter=(35.7704, 129.4204),
    region_bounds=(35.718, 35.822, 129.356, 129.488),
