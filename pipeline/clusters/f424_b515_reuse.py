"""Cluster config for f424_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f424_b515_reuse",
    region="f424_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f424_b515_reuse_cluster"),
    epicenter=(35.7266, 129.4124),
    region_bounds=(35.676, 35.777, 129.36, 129.464),
