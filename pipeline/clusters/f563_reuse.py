"""Cluster config for f563_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f563_reuse",
    region="f563_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f563_reuse_cluster"),
    epicenter=(35.832, 129.4088),
    region_bounds=(35.781, 35.883, 129.356, 129.462),
