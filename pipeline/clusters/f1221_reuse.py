"""Cluster config for f1221_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1221_reuse",
    region="f1221_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1221_reuse_cluster"),
    epicenter=(35.7181, 129.3521),
    region_bounds=(35.667, 35.769, 129.301, 129.403),
