"""Cluster config for f1201_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1201_reuse",
    region="f1201_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1201_reuse_cluster"),
    epicenter=(35.7104, 129.3546),
    region_bounds=(35.66, 35.761, 129.304, 129.405),
