"""Cluster config for f439_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f439_b515_reuse",
    region="f439_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f439_b515_reuse_cluster"),
    epicenter=(35.7319, 129.4308),
    region_bounds=(35.673, 35.793, 129.371, 129.487),
