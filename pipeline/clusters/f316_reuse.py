"""Cluster config for f316_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f316_reuse",
    region="f316_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f316_reuse_cluster"),
    epicenter=(35.8197, 129.414),
    region_bounds=(35.768, 35.871, 129.36, 129.468),
