"""Cluster config for f859_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f859_b515_reuse",
    region="f859_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f859_b515_reuse_cluster"),
    epicenter=(35.7349, 129.3015),
    region_bounds=(35.684, 35.786, 129.251, 129.352),
