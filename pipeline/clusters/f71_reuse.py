"""Cluster config for f71_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f71_reuse",
    region="f71_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f71_reuse_cluster"),
    epicenter=(35.7859, 129.3034),
    region_bounds=(35.736, 35.836, 129.252, 129.355),
