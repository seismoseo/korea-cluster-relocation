"""Cluster config for f1327_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1327_reuse",
    region="f1327_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1327_reuse_cluster"),
    epicenter=(35.7061, 129.3688),
    region_bounds=(35.648, 35.772, 129.319, 129.419),
