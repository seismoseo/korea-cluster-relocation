"""Cluster config for f1085_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1085_b515_reuse",
    region="f1085_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1085_b515_reuse_cluster"),
    epicenter=(35.714, 129.3566),
    region_bounds=(35.66, 35.77, 129.304, 129.408),
