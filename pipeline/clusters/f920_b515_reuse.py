"""Cluster config for f920_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f920_b515_reuse",
    region="f920_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f920_b515_reuse_cluster"),
    epicenter=(35.7507, 129.4034),
    region_bounds=(35.694, 35.807, 129.348, 129.464),
