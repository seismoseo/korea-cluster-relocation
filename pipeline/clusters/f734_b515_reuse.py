"""Cluster config for f734_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f734_b515_reuse",
    region="f734_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f734_b515_reuse_cluster"),
    epicenter=(35.7218, 129.4031),
    region_bounds=(35.67, 35.775, 129.35, 129.457),
