"""Cluster config for f221_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f221_b515_reuse",
    region="f221_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f221_b515_reuse_cluster"),
    epicenter=(35.8197, 129.4028),
    region_bounds=(35.768, 35.871, 129.352, 129.454),
