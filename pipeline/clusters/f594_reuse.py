"""Cluster config for f594_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f594_reuse",
    region="f594_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f594_reuse_cluster"),
    epicenter=(35.7289, 129.3648),
    region_bounds=(35.677, 35.78, 129.313, 129.418),
