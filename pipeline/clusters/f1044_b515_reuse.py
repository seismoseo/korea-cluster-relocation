"""Cluster config for f1044_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1044_b515_reuse",
    region="f1044_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1044_b515_reuse_cluster"),
    epicenter=(35.6932, 129.3723),
    region_bounds=(35.62, 35.748, 129.315, 129.428),
