"""Cluster config for f647_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f647_reuse",
    region="f647_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f647_reuse_cluster"),
    epicenter=(35.8092, 129.421),
    region_bounds=(35.756, 35.862, 129.37, 129.472),
