"""Cluster config for f197_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f197_b515_reuse",
    region="f197_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f197_b515_reuse_cluster"),
    epicenter=(35.6372, 129.3769),
    region_bounds=(35.587, 35.687, 129.324, 129.428),
