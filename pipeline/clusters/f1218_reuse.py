"""Cluster config for f1218_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1218_reuse",
    region="f1218_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1218_reuse_cluster"),
    epicenter=(35.7141, 129.3536),
    region_bounds=(35.651, 35.771, 129.299, 129.408),
