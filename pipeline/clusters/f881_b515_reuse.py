"""Cluster config for f881_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f881_b515_reuse",
    region="f881_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f881_b515_reuse_cluster"),
    epicenter=(35.728, 129.4101),
    region_bounds=(35.675, 35.781, 129.359, 129.462),
