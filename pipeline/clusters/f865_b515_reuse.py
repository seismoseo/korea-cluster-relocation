"""Cluster config for f865_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f865_b515_reuse",
    region="f865_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f865_b515_reuse_cluster"),
    epicenter=(35.7879, 129.4186),
    region_bounds=(35.735, 35.84, 129.367, 129.471),
