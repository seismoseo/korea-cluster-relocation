"""Cluster config for f738_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f738_reuse",
    region="f738_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f738_reuse_cluster"),
    epicenter=(35.6938, 129.3721),
    region_bounds=(35.623, 35.748, 129.315, 129.428),
