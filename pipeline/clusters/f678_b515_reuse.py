"""Cluster config for f678_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f678_b515_reuse",
    region="f678_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f678_b515_reuse_cluster"),
    epicenter=(35.7094, 129.4046),
    region_bounds=(35.658, 35.762, 129.353, 129.458),
