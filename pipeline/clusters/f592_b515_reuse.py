"""Cluster config for f592_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f592_b515_reuse",
    region="f592_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f592_b515_reuse_cluster"),
    epicenter=(35.7255, 129.4091),
    region_bounds=(35.673, 35.779, 129.357, 129.462),
