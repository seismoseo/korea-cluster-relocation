"""Cluster config for f921_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f921_b515_reuse",
    region="f921_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f921_b515_reuse_cluster"),
