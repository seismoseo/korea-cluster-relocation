"""Cluster config for f401_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f401_b515_reuse",
    region="f401_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f401_b515_reuse_cluster"),
    epicenter=(35.7858, 129.3036),
    region_bounds=(35.735, 35.836, 129.252, 129.355),
