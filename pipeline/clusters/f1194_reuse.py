"""Cluster config for f1194_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1194_reuse",
    region="f1194_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1194_reuse_cluster"),
    epicenter=(35.7581, 129.3839),
    region_bounds=(35.7, 35.813, 129.33, 129.438),
