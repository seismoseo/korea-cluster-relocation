"""Cluster config for f414_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f414_reuse",
    region="f414_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f414_reuse_cluster"),
    epicenter=(35.7099, 129.4055),
    region_bounds=(35.659, 35.762, 129.354, 129.458),
