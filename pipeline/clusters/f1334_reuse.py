"""Cluster config for f1334_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1334_reuse",
    region="f1334_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1334_reuse_cluster"),
    epicenter=(35.7157, 129.3692),
    region_bounds=(35.657, 35.778, 129.319, 129.42),
