"""Cluster config for f495_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f495_b515_reuse",
    region="f495_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f495_b515_reuse_cluster"),
    epicenter=(35.7793, 129.3641),
    region_bounds=(35.726, 35.832, 129.31, 129.42),
