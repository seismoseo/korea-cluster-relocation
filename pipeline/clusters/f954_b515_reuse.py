"""Cluster config for f954_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f954_b515_reuse",
    region="f954_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f954_b515_reuse_cluster"),
    epicenter=(35.716, 129.3787),
    region_bounds=(35.66, 35.77, 129.327, 129.431),
