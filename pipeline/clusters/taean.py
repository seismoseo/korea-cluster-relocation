"""Cluster config for Taean — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="taean",
    region="Taean",
    src_root=os.path.join(config.PROJECT_ROOT, "Taean_cluster"),
    epicenter=(36.801, 126.246),
    region_bounds=(36.59, 37.01, 126.04, 126.47),
