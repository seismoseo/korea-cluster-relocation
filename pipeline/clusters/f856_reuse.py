"""Cluster config for f856_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f856_reuse",
    region="f856_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f856_reuse_cluster"),
    epicenter=(35.8143, 129.3774),
    region_bounds=(35.742, 35.869, 129.312, 129.431),
