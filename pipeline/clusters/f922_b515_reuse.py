"""Cluster config for f922_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f922_b515_reuse",
    region="f922_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f922_b515_reuse_cluster"),
    epicenter=(35.7178, 129.3638),
    region_bounds=(35.665, 35.77, 129.312, 129.415),
