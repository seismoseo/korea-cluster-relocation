"""Cluster config for f539_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f539_reuse",
    region="f539_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f539_reuse_cluster"),
    epicenter=(35.7253, 129.409),
    region_bounds=(35.674, 35.776, 129.357, 129.462),
