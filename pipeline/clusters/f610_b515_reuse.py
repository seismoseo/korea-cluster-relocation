"""Cluster config for f610_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f610_b515_reuse",
    region="f610_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f610_b515_reuse_cluster"),
    epicenter=(35.7481, 129.2957),
    region_bounds=(35.697, 35.799, 129.243, 129.347),
