"""Cluster config for f857_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f857_b515_reuse",
    region="f857_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f857_b515_reuse_cluster"),
    epicenter=(35.7539, 129.4015),
    region_bounds=(35.7, 35.813, 129.35, 129.454),
