"""Cluster config for f907_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f907_b515_reuse",
    region="f907_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f907_b515_reuse_cluster"),
    epicenter=(35.7714, 129.3788),
    region_bounds=(35.721, 35.823, 129.326, 129.431),
