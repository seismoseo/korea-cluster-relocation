"""Cluster config for f327_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f327_b515_reuse",
    region="f327_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f327_b515_reuse_cluster"),
    epicenter=(35.8024, 129.414),
    region_bounds=(35.752, 35.853, 129.361, 129.466),
