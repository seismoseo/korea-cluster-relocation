"""Cluster config for f595_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f595_reuse",
    region="f595_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f595_reuse_cluster"),
    epicenter=(35.7294, 129.3661),
    region_bounds=(35.678, 35.78, 129.312, 129.418),
