"""Cluster config for f226_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f226_b515_reuse",
    region="f226_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f226_b515_reuse_cluster"),
    epicenter=(35.8319, 129.4059),
    region_bounds=(35.781, 35.883, 129.352, 129.462),
