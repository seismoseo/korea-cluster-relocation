"""Cluster config for f1171_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1171_reuse",
    region="f1171_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1171_reuse_cluster"),
    epicenter=(35.7518, 129.4025),
    region_bounds=(35.695, 35.807, 129.348, 129.456),
