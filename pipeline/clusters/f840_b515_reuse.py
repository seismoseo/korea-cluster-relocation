"""Cluster config for f840_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f840_b515_reuse",
    region="f840_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f840_b515_reuse_cluster"),
    epicenter=(35.7867, 129.3666),
    region_bounds=(35.736, 35.837, 129.316, 129.417),
