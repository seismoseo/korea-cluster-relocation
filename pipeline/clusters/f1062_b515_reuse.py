"""Cluster config for f1062_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1062_b515_reuse",
    region="f1062_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1062_b515_reuse_cluster"),
    epicenter=(35.7068, 129.3696),
    region_bounds=(35.639, 35.778, 129.319, 129.421),
