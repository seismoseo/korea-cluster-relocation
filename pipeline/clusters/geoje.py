"""Cluster config for Geoje — auto-generated by PocketQuake."""
...
CONFIG = kma_cluster(
    name="geoje",
    region="Geoje",
    src_root=os.path.join(config.PROJECT_ROOT, "Geoje_cluster"),
    epicenter=(34.816, 128.658),
    region_bounds=(34.61, 35.02, 128.45, 128.86),
