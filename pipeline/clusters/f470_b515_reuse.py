"""Cluster config for f470_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f470_b515_reuse",
    region="f470_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f470_b515_reuse_cluster"),
    epicenter=(35.684, 129.5402),
    region_bounds=(35.633, 35.735, 129.489, 129.594),
