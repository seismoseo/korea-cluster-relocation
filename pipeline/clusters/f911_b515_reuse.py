"""Cluster config for f911_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f911_b515_reuse",
    region="f911_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f911_b515_reuse_cluster"),
    epicenter=(35.7884, 129.4155),
    region_bounds=(35.737, 35.841, 129.363, 129.468),
