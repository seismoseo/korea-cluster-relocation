"""Cluster config for f1085_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1085_reuse",
    region="f1085_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1085_reuse_cluster"),
    epicenter=(35.7666, 129.3795),
    region_bounds=(35.714, 35.818, 129.325, 129.434),
