"""Cluster config for f321_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f321_reuse",
    region="f321_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f321_reuse_cluster"),
    epicenter=(35.8216, 129.4168),
    region_bounds=(35.771, 35.874, 129.366, 129.469),
