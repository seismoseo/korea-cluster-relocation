"""Cluster config for f249_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f249_b515_reuse",
    region="f249_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f249_b515_reuse_cluster"),
    epicenter=(35.7446, 129.2946),
    region_bounds=(35.692, 35.799, 129.244, 129.345),
