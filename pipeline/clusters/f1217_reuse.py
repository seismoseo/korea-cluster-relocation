"""Cluster config for f1217_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1217_reuse",
    region="f1217_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1217_reuse_cluster"),
    epicenter=(35.714, 129.353),
    region_bounds=(35.658, 35.767, 129.299, 129.405),
