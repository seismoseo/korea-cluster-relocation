"""Cluster config for f1232_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1232_reuse",
    region="f1232_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1232_reuse_cluster"),
    epicenter=(35.7647, 129.3943),
    region_bounds=(35.714, 35.817, 129.343, 129.446),
