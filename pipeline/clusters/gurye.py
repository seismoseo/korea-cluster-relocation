"""Cluster config for Gurye — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="gurye",
    region="Gurye",
    src_root=os.path.join(config.PROJECT_ROOT, "Gurye_cluster"),
    epicenter=(35.315, 127.422),
    region_bounds=(35.11, 35.52, 127.21, 127.63),
