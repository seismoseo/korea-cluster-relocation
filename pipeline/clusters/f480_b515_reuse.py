"""Cluster config for f480_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f480_b515_reuse",
    region="f480_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f480_b515_reuse_cluster"),
    epicenter=(35.7271, 129.3521),
    region_bounds=(35.675, 35.779, 129.299, 129.406),
