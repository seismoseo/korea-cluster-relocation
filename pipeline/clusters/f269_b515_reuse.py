"""Cluster config for f269_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f269_b515_reuse",
    region="f269_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f269_b515_reuse_cluster"),
    epicenter=(35.8154, 129.3121),
    region_bounds=(35.765, 35.866, 129.262, 129.363),
