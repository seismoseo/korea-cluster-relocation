"""Cluster config for f1203_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1203_reuse",
    region="f1203_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1203_reuse_cluster"),
    epicenter=(35.71, 129.3562),
    region_bounds=(35.654, 35.764, 129.291, 129.41),
