"""Cluster config for f487_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f487_b515_reuse",
    region="f487_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f487_b515_reuse_cluster"),
    epicenter=(35.732, 129.4077),
    region_bounds=(35.679, 35.79, 129.354, 129.464),
