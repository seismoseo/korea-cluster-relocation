"""Cluster config for f1376_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1376_reuse",
    region="f1376_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1376_reuse_cluster"),
    epicenter=(35.7218, 129.4031),
    region_bounds=(35.671, 35.774, 129.352, 129.456),
