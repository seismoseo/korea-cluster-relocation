"""Cluster config for f414_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f414_b515_reuse",
    region="f414_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f414_b515_reuse_cluster"),
