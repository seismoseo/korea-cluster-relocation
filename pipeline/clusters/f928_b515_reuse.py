"""Cluster config for f928_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f928_b515_reuse",
    region="f928_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f928_b515_reuse_cluster"),
    epicenter=(35.7243, 129.3625),
    region_bounds=(35.642, 35.826, 129.291, 129.445),
