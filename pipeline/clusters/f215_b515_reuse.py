"""Cluster config for f215_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f215_b515_reuse",
    region="f215_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f215_b515_reuse_cluster"),
