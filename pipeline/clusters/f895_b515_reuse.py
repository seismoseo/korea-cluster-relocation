"""Cluster config for f895_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f895_b515_reuse",
    region="f895_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f895_b515_reuse_cluster"),
    epicenter=(35.7947, 129.3777),
    region_bounds=(35.744, 35.847, 129.325, 129.429),
