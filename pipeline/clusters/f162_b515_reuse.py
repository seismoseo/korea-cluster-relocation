"""Cluster config for f162_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f162_b515_reuse",
    region="f162_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f162_b515_reuse_cluster"),
    epicenter=(35.8295, 129.4458),
    region_bounds=(35.779, 35.88, 129.396, 129.496),
