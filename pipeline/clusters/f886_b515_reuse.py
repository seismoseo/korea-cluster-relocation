"""Cluster config for f886_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f886_b515_reuse",
    region="f886_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f886_b515_reuse_cluster"),
    epicenter=(35.8247, 129.3864),
    region_bounds=(35.774, 35.876, 129.334, 129.439),
