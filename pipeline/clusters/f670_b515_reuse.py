"""Cluster config for f670_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f670_b515_reuse",
    region="f670_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f670_b515_reuse_cluster"),
    epicenter=(35.7757, 129.3907),
    region_bounds=(35.724, 35.828, 129.339, 129.443),
