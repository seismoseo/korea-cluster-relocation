"""Cluster config for f1423_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1423_reuse",
    region="f1423_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1423_reuse_cluster"),
    epicenter=(35.7041, 129.3676),
    region_bounds=(35.652, 35.757, 129.317, 129.418),
