"""Cluster config for Youngcheon — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="youngcheon",
    region="Youngcheon",
    src_root=os.path.join(config.PROJECT_ROOT, "Youngcheon_cluster"),
    epicenter=(35.938, 128.89),
    region_bounds=(35.73, 36.15, 128.68, 129.1),
