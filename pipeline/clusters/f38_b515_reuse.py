"""Cluster config for f38_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f38_b515_reuse",
    region="f38_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f38_b515_reuse_cluster"),
    epicenter=(35.803, 129.2706),
    region_bounds=(35.753, 35.853, 129.219, 129.323),
