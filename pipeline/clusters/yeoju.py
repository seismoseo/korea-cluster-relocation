"""Cluster config for Yeoju — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="yeoju",
    region="Yeoju",
    src_root=os.path.join(config.PROJECT_ROOT, "Yeoju_cluster"),
    epicenter=(37.294, 127.708),
    region_bounds=(37.09, 37.5, 127.5, 127.91),
