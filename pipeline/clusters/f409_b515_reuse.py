"""Cluster config for f409_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f409_b515_reuse",
    region="f409_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f409_b515_reuse_cluster"),
