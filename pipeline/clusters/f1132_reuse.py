"""Cluster config for f1132_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1132_reuse",
    region="f1132_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1132_reuse_cluster"),
    epicenter=(35.7868, 129.3672),
    region_bounds=(35.736, 35.837, 129.316, 129.419),
