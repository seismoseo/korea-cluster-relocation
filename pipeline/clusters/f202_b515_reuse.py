"""Cluster config for f202_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f202_b515_reuse",
    region="f202_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f202_b515_reuse_cluster"),
    epicenter=(35.6973, 129.404),
    region_bounds=(35.634, 35.762, 129.345, 129.458),
