"""Cluster config for f741_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f741_b515_reuse",
    region="f741_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f741_b515_reuse_cluster"),
    epicenter=(35.7166, 129.4056),
    region_bounds=(35.646, 35.779, 129.35, 129.461),
