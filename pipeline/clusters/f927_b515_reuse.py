"""Cluster config for f927_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f927_b515_reuse",
    region="f927_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f927_b515_reuse_cluster"),
    epicenter=(35.7706, 129.3699),
    region_bounds=(35.716, 35.829, 129.318, 129.425),
