"""Cluster config for f885_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f885_b515_reuse",
    region="f885_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f885_b515_reuse_cluster"),
    epicenter=(35.8145, 129.3784),
    region_bounds=(35.742, 35.869, 129.312, 129.435),
