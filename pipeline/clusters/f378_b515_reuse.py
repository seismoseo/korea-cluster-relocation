"""Cluster config for f378_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f378_b515_reuse",
    region="f378_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f378_b515_reuse_cluster"),
