"""Cluster config for f604_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f604_b515_reuse",
    region="f604_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f604_b515_reuse_cluster"),
    epicenter=(35.7962, 129.431),
    region_bounds=(35.745, 35.848, 129.377, 129.484),
