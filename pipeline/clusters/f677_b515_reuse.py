"""Cluster config for f677_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f677_b515_reuse",
    region="f677_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f677_b515_reuse_cluster"),
    epicenter=(35.7151, 129.4043),
    region_bounds=(35.664, 35.766, 129.354, 129.455),
