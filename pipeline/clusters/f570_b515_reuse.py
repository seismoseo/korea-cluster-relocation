"""Cluster config for f570_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f570_b515_reuse",
    region="f570_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f570_b515_reuse_cluster"),
    epicenter=(35.7819, 129.3083),
    region_bounds=(35.73, 35.835, 129.255, 129.362),
