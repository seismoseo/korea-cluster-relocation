"""Cluster config for f474_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f474_b515_reuse",
    region="f474_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f474_b515_reuse_cluster"),
    epicenter=(35.6861, 129.3699),
    region_bounds=(35.631, 35.744, 129.31, 129.426),
