"""Cluster config for Geochang — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="geochang",
    region="Geochang",
    src_root=os.path.join(config.PROJECT_ROOT, "Geochang_cluster"),
    epicenter=(35.79, 127.804),
    region_bounds=(35.59, 35.99, 127.6, 128.01),
