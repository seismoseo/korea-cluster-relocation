"""Cluster config for f926_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f926_b515_reuse",
    region="f926_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f926_b515_reuse_cluster"),
    epicenter=(35.6947, 129.3764),
    region_bounds=(35.644, 35.745, 129.325, 129.427),
