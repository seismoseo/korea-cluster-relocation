"""Cluster config for f817_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f817_b515_reuse",
    region="f817_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f817_b515_reuse_cluster"),
    epicenter=(35.7245, 129.3684),
