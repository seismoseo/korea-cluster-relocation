"""Cluster config for f953_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f953_reuse",
    region="f953_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f953_reuse_cluster"),
    epicenter=(35.7841, 129.3155),
    region_bounds=(35.732, 35.836, 129.264, 129.366),
