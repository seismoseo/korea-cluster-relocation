"""Cluster config for f717_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f717_b515_reuse",
    region="f717_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f717_b515_reuse_cluster"),
    epicenter=(35.7833, 129.3153),
    region_bounds=(35.732, 35.835, 129.264, 129.366),
