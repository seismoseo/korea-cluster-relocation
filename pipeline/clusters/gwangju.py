"""Cluster config for Gwangju — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="gwangju",
    region="Gwangju",
    src_root=os.path.join(config.PROJECT_ROOT, "Gwangju_cluster"),
    epicenter=(35.132, 126.961),
    region_bounds=(34.91, 35.34, 126.76, 127.17),
