"""Cluster config for Hampyeong — auto-generated by PocketQuake."""
...
CONFIG = kma_cluster(
    name="hampyeong",
    region="Hampyeong",
    src_root=os.path.join(config.PROJECT_ROOT, "Hampyeong_cluster"),
    epicenter=(35.14, 126.498),
    region_bounds=(34.94, 35.34, 126.29, 126.7),
