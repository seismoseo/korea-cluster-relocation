"""Cluster config for Buyeo — auto-generated by PocketQuake."""
...
CONFIG = kma_cluster(
    name="buyeo",
    region="Buyeo",
    src_root=os.path.join(config.PROJECT_ROOT, "Buyeo_cluster"),
    epicenter=(36.27, 126.709),
    region_bounds=(36.07, 36.47, 126.5, 126.91),
