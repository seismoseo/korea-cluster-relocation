"""Cluster config for f674_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f674_b515_reuse",
    region="f674_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f674_b515_reuse_cluster"),
    epicenter=(35.7086, 129.4077),
    region_bounds=(35.657, 35.761, 129.355, 129.46),
