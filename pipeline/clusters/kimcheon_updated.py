"""Cluster config for Kimcheon_updated — auto-generated by PocketQuake."""
...
CONFIG = mixed_cluster(
    name="kimcheon_updated",
    region="Kimcheon_updated",
    src_root=os.path.join(config.PROJECT_ROOT, "Kimcheon_updated_cluster"),
    epicenter=(36.009, 128.009),
    region_bounds=(35.8, 36.21, 127.8, 128.22),
