"""Cluster config for f1057_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1057_reuse",
    region="f1057_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1057_reuse_cluster"),
    epicenter=(35.8077, 129.4363),
    region_bounds=(35.756, 35.859, 129.384, 129.489),
