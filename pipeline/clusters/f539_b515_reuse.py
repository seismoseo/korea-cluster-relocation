"""Cluster config for f539_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f539_b515_reuse",
    region="f539_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f539_b515_reuse_cluster"),
    epicenter=(35.71, 129.3409),
    region_bounds=(35.658, 35.761, 129.29, 129.392),
