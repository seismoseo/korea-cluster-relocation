"""Cluster config for f1020_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1020_reuse",
    region="f1020_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1020_reuse_cluster"),
    epicenter=(35.7271, 129.3685),
    region_bounds=(35.675, 35.782, 129.316, 129.424),
