"""Cluster config for f596_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f596_b515_reuse",
    region="f596_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f596_b515_reuse_cluster"),
    epicenter=(35.7312, 129.4041),
    region_bounds=(35.68, 35.785, 129.352, 129.461),
