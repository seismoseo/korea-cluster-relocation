"""Cluster config for f1058_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1058_reuse",
    region="f1058_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1058_reuse_cluster"),
    epicenter=(35.8075, 129.4355),
    region_bounds=(35.754, 35.861, 129.383, 129.49),
