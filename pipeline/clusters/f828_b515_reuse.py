"""Cluster config for f828_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f828_b515_reuse",
    region="f828_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f828_b515_reuse_cluster"),
    epicenter=(35.8073, 129.4357),
    region_bounds=(35.748, 35.861, 129.383, 129.49),
