"""Cluster config for f629_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f629_b515_reuse",
    region="f629_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f629_b515_reuse_cluster"),
    epicenter=(35.7392, 129.3693),
    region_bounds=(35.689, 35.79, 129.318, 129.421),
