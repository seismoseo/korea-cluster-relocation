"""Cluster config for f1078_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1078_b515_reuse",
    region="f1078_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1078_b515_reuse_cluster"),
    epicenter=(35.6944, 129.3671),
    region_bounds=(35.62, 35.771, 129.316, 129.418),
