"""Cluster config for f690_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f690_reuse",
    region="f690_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f690_reuse_cluster"),
    epicenter=(35.7484, 129.2961),
    region_bounds=(35.698, 35.799, 129.243, 129.349),
