"""Cluster config for f775_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f775_b515_reuse",
    region="f775_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f775_b515_reuse_cluster"),
    epicenter=(35.7862, 129.4177),
    region_bounds=(35.731, 35.839, 129.367, 129.468),
