"""Cluster config for f1058_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1058_b515_reuse",
    region="f1058_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1058_b515_reuse_cluster"),
    epicenter=(35.7077, 129.3679),
    region_bounds=(35.648, 35.772, 129.316, 129.419),
