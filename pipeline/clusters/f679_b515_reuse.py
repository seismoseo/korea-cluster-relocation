"""Cluster config for f679_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f679_b515_reuse",
    region="f679_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f679_b515_reuse_cluster"),
    epicenter=(35.7085, 129.4047),
    region_bounds=(35.656, 35.761, 129.353, 129.458),
