"""Cluster config for f277_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f277_b515_reuse",
    region="f277_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f277_b515_reuse_cluster"),
    epicenter=(35.8089, 129.4222),
    region_bounds=(35.756, 35.862, 129.37, 129.476),
