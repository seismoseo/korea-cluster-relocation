"""Cluster config for f1121_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1121_b515_reuse",
    region="f1121_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1121_b515_reuse_cluster"),
    epicenter=(35.7187, 129.3855),
    region_bounds=(35.638, 35.801, 129.334, 129.437),
