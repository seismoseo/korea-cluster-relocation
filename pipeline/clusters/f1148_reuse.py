"""Cluster config for f1148_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1148_reuse",
    region="f1148_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1148_reuse_cluster"),
    epicenter=(35.7429, 129.3734),
    region_bounds=(35.675, 35.814, 129.319, 129.43),
