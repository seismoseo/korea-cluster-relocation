"""Cluster config for f934_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f934_b515_reuse",
    region="f934_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f934_b515_reuse_cluster"),
    epicenter=(35.7616, 129.3977),
    region_bounds=(35.705, 35.817, 129.343, 129.454),
