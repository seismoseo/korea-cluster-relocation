"""Cluster config for f915_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f915_b515_reuse",
    region="f915_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f915_b515_reuse_cluster"),
    epicenter=(35.7644, 129.3889),
    region_bounds=(35.712, 35.816, 129.337, 129.441),
