"""Cluster config for f389_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f389_reuse",
    region="f389_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f389_reuse_cluster"),
    epicenter=(35.7349, 129.4288),
    region_bounds=(35.68, 35.793, 129.371, 129.483),
