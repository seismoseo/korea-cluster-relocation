"""Cluster config for f566_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f566_reuse",
    region="f566_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f566_reuse_cluster"),
    epicenter=(35.8332, 129.4062),
    region_bounds=(35.782, 35.885, 129.353, 129.462),
