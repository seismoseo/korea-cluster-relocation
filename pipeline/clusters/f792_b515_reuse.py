"""Cluster config for f792_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f792_b515_reuse",
    region="f792_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f792_b515_reuse_cluster"),
    epicenter=(35.7091, 129.4048),
    region_bounds=(35.658, 35.76, 129.353, 129.458),
