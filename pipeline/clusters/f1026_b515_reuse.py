"""Cluster config for f1026_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1026_b515_reuse",
    region="f1026_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1026_b515_reuse_cluster"),
    epicenter=(35.7207, 129.3671),
    region_bounds=(35.62, 35.781, 129.312, 129.42),
