"""Cluster config for f1025_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1025_b515_reuse",
    region="f1025_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1025_b515_reuse_cluster"),
    epicenter=(35.7225, 129.3658),
    region_bounds=(35.662, 35.776, 129.312, 129.42),
