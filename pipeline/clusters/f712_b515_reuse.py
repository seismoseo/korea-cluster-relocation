"""Cluster config for f712_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f712_b515_reuse",
    region="f712_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f712_b515_reuse_cluster"),
    epicenter=(35.7097, 129.4028),
    region_bounds=(35.654, 35.762, 129.35, 129.46),
