"""Cluster config for f660_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f660_b515_reuse",
    region="f660_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f660_b515_reuse_cluster"),
    epicenter=(35.7255, 129.3554),
    region_bounds=(35.67, 35.778, 129.305, 129.407),
