"""Cluster config for f924_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f924_b515_reuse",
    region="f924_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f924_b515_reuse_cluster"),
    epicenter=(35.7117, 129.3851),
    region_bounds=(35.645, 35.767, 129.322, 129.444),
