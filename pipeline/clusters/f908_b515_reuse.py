"""Cluster config for f908_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f908_b515_reuse",
    region="f908_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f908_b515_reuse_cluster"),
    epicenter=(35.7518, 129.3726),
    region_bounds=(35.669, 35.819, 129.29, 129.44),
