"""Cluster config for f306_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f306_reuse",
    region="f306_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f306_reuse_cluster"),
    epicenter=(35.822, 129.4184),
    region_bounds=(35.771, 35.873, 129.366, 129.471),
