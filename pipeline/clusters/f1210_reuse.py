"""Cluster config for f1210_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1210_reuse",
    region="f1210_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1210_reuse_cluster"),
    epicenter=(35.7103, 129.3549),
    region_bounds=(35.659, 35.762, 129.303, 129.408),
