"""Cluster config for f555_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f555_b515_reuse",
    region="f555_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f555_b515_reuse_cluster"),
    epicenter=(35.7261, 129.3661),
    region_bounds=(35.67, 35.778, 129.316, 129.417),
