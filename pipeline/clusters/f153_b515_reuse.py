"""Cluster config for f153_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f153_b515_reuse",
    region="f153_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f153_b515_reuse_cluster"),
    epicenter=(35.7707, 129.2916),
    region_bounds=(35.72, 35.821, 129.24, 129.343),
