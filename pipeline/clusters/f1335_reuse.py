"""Cluster config for f1335_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1335_reuse",
    region="f1335_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1335_reuse_cluster"),
    epicenter=(35.6949, 129.37),
    region_bounds=(35.639, 35.756, 129.32, 129.421),
