"""Cluster config for f345_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f345_b515_reuse",
    region="f345_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f345_b515_reuse_cluster"),
    epicenter=(35.7878, 129.3884),
    region_bounds=(35.733, 35.844, 129.338, 129.439),
