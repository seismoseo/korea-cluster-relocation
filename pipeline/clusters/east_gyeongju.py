"""Cluster config for East_gyeongju — auto-generated by PocketQuake."""
...
CONFIG = mixed_cluster(
    name="east_gyeongju",
    region="East_gyeongju",
    src_root=os.path.join(config.PROJECT_ROOT, "East_gyeongju_cluster"),
    epicenter=(35.832, 129.4),
    region_bounds=(35.63, 36.04, 129.2, 129.6),
