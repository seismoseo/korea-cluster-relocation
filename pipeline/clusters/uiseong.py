"""Cluster config for Uiseong — auto-generated by PocketQuake."""
...
CONFIG = kma_cluster(
    name="uiseong",
    region="Uiseong",
    src_root=os.path.join(config.PROJECT_ROOT, "Uiseong_cluster"),
    epicenter=(36.327, 128.38),
    region_bounds=(36.12, 36.53, 128.18, 128.58),
