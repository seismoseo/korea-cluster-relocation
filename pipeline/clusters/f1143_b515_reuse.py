"""Cluster config for f1143_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f1143_b515_reuse",
    region="f1143_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f1143_b515_reuse_cluster"),
    epicenter=(35.7651, 129.3765),
    region_bounds=(35.705, 35.82, 129.323, 129.429),
