"""Cluster config for f813_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f813_reuse",
    region="f813_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f813_reuse_cluster"),
    epicenter=(35.8008, 129.4143),
    region_bounds=(35.747, 35.853, 129.364, 129.464),
