"""Cluster config for f356_b515_reuse — auto-generated by PocketQuake."""
...
CONFIG = stp_cluster(
    name="f356_b515_reuse",
    region="f356_b515_reuse",
    src_root=os.path.join(config.PROJECT_ROOT, "f356_b515_reuse_cluster"),
    epicenter=(35.8001, 129.416),
    region_bounds=(35.748, 35.853, 129.362, 129.468),
