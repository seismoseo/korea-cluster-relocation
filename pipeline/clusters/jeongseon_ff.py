"""Cluster config for Jeongseon_ff — auto-generated by PocketQuake."""
...
CONFIG = mixed_cluster(
    name="jeongseon_ff",
    region="Jeongseon_ff",
    src_root=os.path.join(config.PROJECT_ROOT, "Jeongseon_ff_cluster"),
    epicenter=(37.259, 128.717),
    region_bounds=(37.05, 37.47, 128.51, 128.92),
